...
class GUI:
    def __init__(self, parent):
        ...
        # To associate a scrollbar with a text widget, place the scrollbar carefully with respect to the text widget
        # and set the scrollbar's command to textwidget.{x/y}view as appropriate. Then set the text widget's
        # {x/y}scroolcommand to scrollbal.set as below
