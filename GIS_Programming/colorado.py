#This is a simple program which demonstrates some GIS concepts by drawing the US state of Colorado, while placing the
# major cities at their appropriate locations. Colorado is a suitable simple example as it is a rectangle shape.

import turtle as t

# DATA MODEL
# All layers will have a name, points, and population count. These constants are a shorthand for this.
NAME = 0
POINTS = 1
POP = 2
...
# MAP GRAPHICS RENDERING - size of screen in pixels
map_width = 800
map_height = 500
...
def convert(point):
    """
    Function to convert lat/lon to screen coordinates. Remember screen coordinates are necessary for rendering.
    :param point: The point in lon/lat to convert
